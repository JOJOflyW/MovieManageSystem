        ...
        <div id="templatemo_middle_top"></div>
        	<div id="templatemo_middle">
            	<div id="addbox" class="container">
        			...
        			<form action = "movie.do" method = "POST" id="movieform" >
        			<table>
        			<tr class="movielable"><td>Movie ID：</td>
		   			<td><input type="text"  style="font-size: 15px" placeholder="电影号" name="id" ></input></td></tr>
		     		...
		     		<td><textarea class="area"  form="movieform"  name="info" style="font-size: 15px" placeholder="电影详情信息" ></textarea></td></tr>		     		
		 		
			</table>
				<input type="hidden" class="btn_add" name = "action" value="add">
				<p id="moviebt"><input type="submit" class="btn_add" value="Add It Now"></p>
			</form>		
