	...
	<div id="templatemo_top_wrapper">
		<div id="templatemo_top">
        	<ul id="social_box">
            	...
            	<li class="line"></li>
            	<li class="last"><a href="javascript:void(0);" id="register">免费注册</a></li>
        	</ul>
    	</div>
	</div>
	<div id="hidden">
...
<div id="templatemo_middle_wrapper_outer">
        ...
        <div id="templatemo_middle">
            ...
            <div id="templatemo_content">
                ...
                <div class="post_box">
                    ...
                    <h2><a href="Movie01.jsp">The Twilight Saga</a></h2>

                    <div class="post_meta"><strong>Date:</strong> December 5th, 2019 | <strong>Author:</strong> WyxWltDdnWfj </div>
                    <a href="#"><img alt="image" src="images/pict01.jpg"></a>
                    <p><em>The film tells the story of Edward cullen as a vampire and human woman Isabella swan met and fell in love.</em></p>
                    <p> a smart young girl with a heart of fire, and this incredibly and deadly attractive vampire, they life intersect at this small rainy and cloudy town. something that is destined is about to happen.
                        　　bella has fallen in love incurably with this vampire, and the vampire with this pure-hearted beautiful girl. but can he control his thirst for blood and stay by her side? is bella's so firm that she would risk her life for the sake of it? they did, cuz love is stronger than anything any mankind can imagine!</p>

                    <div class="cleaner_h20"></div>
                    <div class="category"><strong>Category: </strong><a href="#">Love</a>, <a href="#">Panic</a></div> <div class="btn_more float_r"><a href="Movie01.jsp">Read more <span>»</span></a></div>
                    <div class="cleaner"></div>
            ...
            <div id="templatmeo_sidebar">
                ...
                <div class="sidebar_box">
                    <ul class="ads_125">
                        ...
                        <li class="last_row"><a href="http://www.cssmoban.com/"><img alt="banner" src="images/04.jpg"></a></li>
                ...
                <div class="sidebar_box">
                    <h4>Categories</h4>
                    <ul class="tmo_list">
                        <li><a href="index.html">Love Movies</a></li>
                        <li><a href="index.html">Art Movies</a></li>
                        <li><a href="index.html">Action Movies</a></li>
                        <li><a href="index.html">Thriller Movies</a></li>
	...
	<div id="checkin_wrap" class="popup_wrap" >
    	<p>注册账号</p>
  		<form action="login.do"  id="checkin_form" method="post">
			<label class="label" for="checkin_username">用户名：</label>
			<input class="input" type="text" id="checkin_username" name="username" value="" maxlength="50">
			<span class="message" style="display: none;">请输入一个有效的用户名！</span>
			<label class="label" for="checkin_password">密码：</label>
			<input class="input" type="password" id="checkin_password" name="password" value="" maxlength="50">
			<input class="submit" id="btn_checkin" type="button" value="注册">
    	</form>
    	<a class="close" id="checkin_close" href="javascript:void(0);" title="关闭窗口"></a>
   		<span class="notice">注：用户名用于验证您的用户身份<br>请保证您输入的信息有效</span>
	</div>
	<div id="signin_wrap" class="popup_wrap" >
    	<p>用户登录</p>
   		<form action="login.do" id="signin_form" method="post">
        	<label class="label" for="signin_username">用户名：</label>
        	<input class="input" type="text" id="signin_username" name="username" value="" maxlength="50">
        	<span class="message" style="display: none;">请输入一个有效的用户名！</span>
